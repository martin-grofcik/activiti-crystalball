package org.activiti.crystalball.simulator.impl.calendar;
/*
...
public class CronExpression implements Serializable, Cloneable {
    ...
    public Date getTimeAfter(Date afterTime) {
        ...
        while (!gotOne) {
            ...
            // org.activiti.crystalball.processengine.wrapper.test for expressions that never generate a valid fire date,
            // but keep looping...
            if (year > MAX_YEAR) {
                return null;
            }
