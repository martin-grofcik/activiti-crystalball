 ...
 */ 
package org.activiti.crystalball.simulator.impl.juel;
 ...
 * {@link #getType(org.activiti.crystalball.simulator.impl.javax.el.ELContext)}, {@link #getValue(org.activiti.crystalball.simulator.impl.javax.el.ELContext)}, {@link #isReadOnly(org.activiti.crystalball.simulator.impl.javax.el.ELContext)}
 * or {@link #setValue(org.activiti.crystalball.simulator.impl.javax.el.ELContext, Object)}.
 *
 * Instances of this class are usually created using an {@link org.activiti.engine.impl.juel.ExpressionFactoryImpl}.
 *
...
public final class TreeValueExpression extends ValueExpression {
   ...
   * @throws org.activiti.crystalball.simulator.impl.javax.el.ELException if evaluation fails (e.g. property not found, type conversion failed, ...)
   */
	@Override
   ...
   */
	...
	/**
   * Evaluates the expression as an lvalue and determines if {@link #setValue(org.activiti.crystalball.simulator.impl.javax.el.ELContext, Object)}
   * will always fail.
   * @param context used to resolve properties (<code>base.property</code> and <code>base[property]</code>)
   * and to determine the result from the last base/property pair
   * @return <code>true</code> if {@link #setValue(org.activiti.crystalball.simulator.impl.javax.el.ELContext, Object)} always fails.
   * @throws org.activiti.crystalball.simulator.impl.javax.el.ELException if evaluation fails (e.g. property not found, type conversion failed, ...)
	 */
	@Override
   ...
   * @throws org.activiti.crystalball.simulator.impl.javax.el.ELException if evaluation fails (e.g. property not found, type conversion failed, assignment failed...)
	 */
	@Override
