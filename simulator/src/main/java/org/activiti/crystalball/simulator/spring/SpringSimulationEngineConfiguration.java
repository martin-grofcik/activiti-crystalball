...
package org.activiti.crystalball.simulator.spring;
 ...
 * @author Joram Barrez
 */
public class SpringSimulationEngineConfiguration extends SimulationEngineConfigurationImpl {
  ...
  public SpringSimulationEngineConfiguration() {
    transactionsExternallyManaged = true;
  }
  
  @Override
  public SimulationEngine buildSimulationEngine() {
    SimulationEngine simulationEngine = super.buildSimulationEngine();
//    autoDeployResources(processEngine);
  ...
  protected Collection< ? extends CommandInterceptor> getDefaultCommandInterceptorsTxRequired() {
    if (transactionManager==null) {
      throw new ActivitiException("transactionManager is required property for SpringSimulationEngineConfiguration, use "+StandaloneSimulationEngineConfiguration.class.getName()+" otherwise");
    }
...
//  protected void autoDeployResources(SimulationEngine processEngine) {
//    if (deploymentResources!=null && deploymentResources.length>0) {
//      RepositoryServiceWrapper repositoryService = processEngine.getRepositoryService();
//
