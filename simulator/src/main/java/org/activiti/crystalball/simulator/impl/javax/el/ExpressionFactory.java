 ...
 * via factory methods. The {@link #createValueExpression(org.activiti.crystalball.simulator.impl.javax.el.ELContext, String, Class)} method is used
 * to parse expressions that evaluate to values (both l-values and r-values are supported). The
 * {@link #createMethodExpression(org.activiti.crystalball.simulator.impl.javax.el.ELContext, String, Class, Class[])} method is used to parse
 ...
 * at evaluation time, via the {@link ELResolver} associated with the {@link org.activiti.crystalball.simulator.impl.javax.el.ELContext} passed to
 ...
 * expression. Therefore, the {@link org.activiti.crystalball.simulator.impl.javax.el.ELContext}, {@link FunctionMapper}, and {@link VariableMapper}
...
public abstract class ExpressionFactory {
	 ...
	 */
	public abstract MethodExpression createMethodExpression(org.activiti.crystalball.simulator.impl.javax.el.ELContext context, String expression,
	 ...
	 *             if paramTypes is null.
	 */
	public abstract ValueExpression createValueExpression(org.activiti.crystalball.simulator.impl.javax.el.ELContext context, String expression, Class<?> expectedType);
