...
import org.activiti.crystalball.simulator.impl.javax.el.ELException;
import org.activiti.crystalball.simulator.impl.javax.el.ExpressionFactory;
 ...
 * {@link org.activiti.crystalball.simulator.impl.javax.el.ExpressionFactory#newInstance()} will then return an instance of this class, configured as
 * described below.
 *
 ...
 * </ol>
 * There are also constructors to explicitly pass in an instance of {@link java.util.Properties}.
 *
...
public class ExpressionFactoryImpl extends ExpressionFactory {
	...
	protected TreeStore createTreeStore(int defaultCacheSize, Profile profile, Properties properties) {
		...
		if (properties == null) {
			...
			EnumSet<Feature> features = EnumSet.noneOf(Builder.Feature.class);
