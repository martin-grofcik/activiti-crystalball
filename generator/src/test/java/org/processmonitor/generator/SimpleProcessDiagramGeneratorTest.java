...
public class SimpleProcessDiagramGeneratorTest {
  ...
  public void after() {
	...
	public void testReturnedProcessInstance() throws Throwable {
	    ...
	    //check outputs
		File expected = new File("src/test/resources/org/processmonitor/generator/SimpleProcessDiagramGeneratorTestExpected.png" );   
		File generated = new File("target/SimpleProcessDiagramGeneratorTest.png");   
