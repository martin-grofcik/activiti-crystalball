...
/**
 * RepositoryServiceWrapper wrapper
 */
public interface RepositoryServiceWrapper {

    ProcessDefinitionQueryWrapper createProcessDefinitionQuery();

    ProcessDefinitionWrapper getDeployedProcessDefinition(String id);
}
