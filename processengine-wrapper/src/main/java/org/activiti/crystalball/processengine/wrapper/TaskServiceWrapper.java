...
public interface TaskServiceWrapper {
    ...
    TaskWrapper newTask(String taskId);
     ...
     */
    void saveTask(TaskWrapper task);
     ...
     * @#IdentityLinkthrows ActivitiException when the task or user doesn't exist.
     */
     ...
     */
    List<IdentityLinkWrapper> getIdentityLinksForTask(String taskId);
     ...
     */
    TaskQueryWrapper createTaskQuery();

    /**
     * Returns a new
     */
    NativeTaskQueryWrapper createNativeTaskQuery();
    ...
    List<CommentWrapper> getTaskComments(String taskId);

    /** The all events related to the given task. */
    List<EventWrapper> getTaskEvents(String taskId);

    /** The comments related to the given process instance. */
    List<CommentWrapper> getProcessInstanceComments(String processInstanceId);

    /** Add a new attachment to a task and/or a process instance and use an input stream to provide the content */
    AttachmentWrapper createAttachment(String attachmentType, String taskId, String processInstanceId, String attachmentName, String attachmentDescription, InputStream content);

    /** Add a new attachment to a task and/or a process instance and use an url as the content */
    AttachmentWrapper createAttachment(String attachmentType, String taskId, String processInstanceId, String attachmentName, String attachmentDescription, String url);

    /** Update the name and decription of an attachment */
    void saveAttachment(AttachmentWrapper attachment);

    /** Retrieve a particular attachment */
    AttachmentWrapper getAttachment(String attachmentId);

    /** Retrieve stream content of a particular attachment */
    InputStream getAttachmentContent(String attachmentId);

    /** The list of attachments associated to a task */
    List<AttachmentWrapper> getTaskAttachments(String taskId);

    /** The list of attachments associated to a process instance */
    List<AttachmentWrapper> getProcessInstanceAttachments(String processInstanceId);

    /** Delete an attachment */
    void deleteAttachment(String attachmentId);

    /** The list of subtasks for this parent task */
    List<TaskWrapper> getSubTasks(String parentTaskId);}
